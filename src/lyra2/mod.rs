...
pub fn sum(k: u64, pwd: Vec<u8>, salt: Vec<u8>, time_cost: u64, n_rows: u64, n_cols: u64) -> Vec<u8>{
	...
	let n_blocks_input:u64 = ((salt.len() as u64 + pwd.len() as u64 + 6*8) / BLOCKLENBLAKE2SAFEBYTES) + 1;
	...
	for _i in 0..n_cols {
		...
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +0) as usize] = whole_matrix[(_i*BLOCKLENINT64 +0) as usize] ^ state[0];
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +1) as usize] = whole_matrix[(_i*BLOCKLENINT64 +1) as usize] ^ state[1];
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +2) as usize] = whole_matrix[(_i*BLOCKLENINT64 +2) as usize] ^ state[2];
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +3) as usize] = whole_matrix[(_i*BLOCKLENINT64 +3) as usize] ^ state[3];
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +4) as usize] = whole_matrix[(_i*BLOCKLENINT64 +4) as usize] ^ state[4];
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +5) as usize] = whole_matrix[(_i*BLOCKLENINT64 +5) as usize] ^ state[5];
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +6) as usize] = whole_matrix[(_i*BLOCKLENINT64 +6) as usize] ^ state[6];
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +7) as usize] = whole_matrix[(_i*BLOCKLENINT64 +7) as usize] ^ state[7];
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +8) as usize] = whole_matrix[(_i*BLOCKLENINT64 +8) as usize] ^ state[8];
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +9) as usize] = whole_matrix[(_i*BLOCKLENINT64 +9) as usize] ^ state[9];
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +10) as usize] = whole_matrix[(_i*BLOCKLENINT64 +10) as usize] ^ state[10];
		whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row_len_int64 +11) as usize] = whole_matrix[(_i*BLOCKLENINT64 +11) as usize] ^ state[11];
	}
	...
	for _x in _x..n_rows {
		...
		for _i in 0..n_cols {
			...
			state[0] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +0) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +0) as usize]);
			state[1] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +1) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +1) as usize]);
			state[2] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +2) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +2) as usize]);
			state[3] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +3) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +3) as usize]);
			state[4] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +4) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +4) as usize]);
			state[5] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +5) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +5) as usize]);
			state[6] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +6) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +6) as usize]);
			state[7] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +7) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +7) as usize]);
			state[8] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +8) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +8) as usize]);
			state[9] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +9) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +9) as usize]);
			state[10] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +10) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +10) as usize]);
			state[11] ^= whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +11) as usize].wrapping_add(whole_matrix[(_i*BLOCKLENINT64+ rowa*row_len_int64 +11) as usize]);

			//Applies the reduced-round transformation f to the sponge's state
			state = reduced_blake2b_lyra(state);

			//M[row][col] = M[prev][col] XOR rand
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +0) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +0) as usize] ^ state[0];
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +1) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +1) as usize] ^ state[1];
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +2) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +2) as usize] ^ state[2];
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +3) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +3) as usize] ^ state[3];
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +4) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +4) as usize] ^ state[4];
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +5) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +5) as usize] ^ state[5];
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +6) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +6) as usize] ^ state[6];
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +7) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +7) as usize] ^ state[7];
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +8) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +8) as usize] ^ state[8];
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +9) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +9) as usize] ^ state[9];
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +10) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +10) as usize] ^ state[10];
			whole_matrix[((n_cols - _i - 1)*BLOCKLENINT64 + row*row_len_int64 +11) as usize] = whole_matrix[(_i*BLOCKLENINT64 + prev*row_len_int64 +11) as usize] ^ state[11];
